...
const TermsPolicy = () => {
	...
	return (
		<Layout page={'Coronavirus - Sobre'} footer={false}>
			<Helmet>
				...
				<meta property='og:site_name' content='Coronavirus - Sobre' />
			</Helmet>
			<div className='terms'>
				<div className='parag'>
					<h1>Políticas</h1>
				...
				<div className='parag'>
					...
					<p><b>###</b> Informações sobre o computador incluindo endereço IP, localização geográfica, tipo de navegador e versão, duração de visita e sistema operacional.</p>
					<p><b>###</b> Informações sobre sua visita e uso do website incluindo fonte de referência, duração da visita, visualizações de página e caminhos de navegação no website.</p>
					<p><b>###</b> Informações como email, nome e demais informações enviadas ao entrar em contato conosco via email incluindo conteúdo e metadados.</p>
					<p><b>###</b> Informações geradas enquanto usa o website incluindo onde, com que frequência e em que circunstâncias.</p>
					<p><b>###</b> Qualquer outra informação pessoal enviada para nós.</p>
				</div>
				<div className='parag'>
        ...
        <div className='parag'>
					<h1>Dados pessoais coletados para os seguintes propósitos e usando os seguintes serviços</h1>
					<p>
					...
					<p>
						Anúncios: Google AdSense e Criteo. Dados pessoais: cookies e dados de uso. Você pode desativar a personalização de anúncios do Google através das <a rel='noopener noreferrer' href='https://www.google.com/settings/ads' target='_blank'>configurações de anúncios</a>. Leia também a <a rel='noopener noreferrer' href='https://www.criteo.com/br/privacy/' target='_blank'>política de privacidade da Criteo</a>.
					</p>
					<p>
						Hospedagem e infraestrutura do backend: Heroku. Dados pessoais: os especificados na política de privacidade do serviço.
					</p>
					<p>
				...
				<div className='parag'>
					<h1>Mais informações sobre dados pessoais</h1>
					<p>
        ...
        <div className='parag'>
				...
				<div className='parag'>
					<h1>Compartilhamento de informação perante à lei</h1>
					<p>
				...
				<div className='parag'>
					<h1>Transferência de dados entre países</h1>
					<p>
				...
				<div className='parag'>
					<h1>Contato</h1>
					<p>
						Proprietário: FabioKido
          </p>
					<p>
						Email: fabioquido14@gmail.com
          </p>
				</div>
			</div>
		</Layout>
